...
parser.add_argument('--result_path', type=str,default='/home/xiao/pythoncode/MyCode/SOT_Draw_Rect/SOTDrawRect/raw_result/GOT-10k',
                    help='the path where raw results are saved')
parser.add_argument('--tracker_name', type=str,default='MixFormer')
